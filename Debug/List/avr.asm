...
; 0000 008F 
; 0000 0090       for (kolom=8;kolom>=0;kolom--){	//(untuk running text dari kanan ke kiri)
	LDI  R30,LOW(8)
	MOV  R5,R30
_0x7:
	LDI  R30,LOW(0)
...
; 0000 0091       lcd_clear();
	CALL _lcd_clear
; 0000 0092   lcd_gotoxy(kolom,0);
	ST   -Y,R5
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 0093   lcd_putsf("NICO");	//(Isi text pertama sesuai selera :V)
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 0094   lcd_gotoxy(kolom,1);
	ST   -Y,R5
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 0095   lcd_putsf("LAHARA");		//(Ini text ke dua *yg bawahnya*)
	__POINTW2FN _0x0,5
	CALL _lcd_putsf
; 0000 0096   delay_ms(200);  		//(delay waktu terserah elu mau ngasih angka berapa, semakin kecil
	LDI  R26,LOW(200)
	LDI  R27,0
	CALL _delay_ms
; 0000 0097   };			 	  //maka semakin cepat dan sebaliknya)
	DEC  R5
	RJMP _0x7
_0x8:
; 0000 0098   }
